...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="#" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Cek Kode</a>
            @endif
            @endauth
        </div>
        @endif
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <a href="/">
                    <img src="{{ asset('img/logo.png') }}" height="100px" width="100px" class=" rounded-full" alt="Example Image">
                </a>
                <style>
                    .rounded-full {
                        border-radius: 50%;
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a id="link" href="/check-kode" class="underline text-gray-900 dark:text-white">Cek Kode Pendaftaran</a></div>
                        </div>
                        <div class="ml-2">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <p class=" justified-text ">
                                    Selamat datang Jama'ah Mujahadah Kubro, <br>
                                    Silahkan lakukan pengecekan pendaftaran peserta dengan benar dibawah ini :
                                </p>
                                <a class="link" href="/check-kode">
                                    <button>CHECK KODE PENDAFTARAN</button>
                                </a>
                            </div>
                        </div>
                    </div>
